...
@interface Update_profile : UIViewController<UIScrollViewDelegate,UITextViewDelegate,UITextFieldDelegate,UIImagePickerControllerDelegate,UITableViewDelegate,UITableViewDataSource,UINavigationControllerDelegate>
{
    ...
    IBOutlet UIView *vital_status_subview;
    ///////////////upload_view/////////////////
    ...
    IBOutlet UIButton *btnupdatePro;
    ...
    NSString *temp_lang_names;
    NSMutableArray *lang_name_edit_arr;
    NSArray *lang_store_ids;
    NSMutableArray *lang_edit_arr;
    NSArray *splitLangNames;
    NSArray *splitLangIDs;
    NSMutableArray *lang_url_names;
    NSMutableArray *lang_url_ids;
    ...
    NSString *race_update_string;
    NSString *height_update_string;
    NSString *weight_update_string;
    NSString *waist_update_string;
    NSString *hips_update_string;
    NSString *bust_update_string;
    NSString *cup_update_string;
    
    NSString *haircolor_update_string;
    NSString *eyecolor_update_string;
    NSString *eduleve_update_string;
    NSString *drinker_update_string;
    NSString *smoker_update_string;
    NSString *int_update_string;
    NSString *looking_update_string;
    NSString *speaks_stringID;

    
    NSString *tagline_update_string;
    NSString *shortdesc_update_string;
    NSString *longdesc_update_string;
    NSString *lastLogin_update_string;
    NSString *userid_update_string;
    NSString *fetch_uid_update;
    ...
    NSString *passwd_select;
    
    NSString *booking_fee_string;
    NSString *booking_hr_string;
    NSString *speaks_string;
    NSString *real_name_string;
    NSString *name_string_new;
...
@property (retain, nonatomic) IBOutlet NSArray *selectedIndexes ;
